...
> The original project brief and commercial framing, kept for context. It
> describes the intent behind the system; what is actually built and working
> today is documented in the [README](../README.md) and
> [`architecture.md`](architecture.md).
>
> Revenue and market figures below are the author's projections, not measured
> results.
